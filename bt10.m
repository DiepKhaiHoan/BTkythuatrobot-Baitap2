...
syms t1 t2 t3 t4 pi;
l1=30; l2=10; l3=20; l4=15; l5=10; l6=10;
for t1=0:0.4:pi/2
    for t2=0:0.4:pi/2
        for t3=0:0.4:pi/2
            for t4=0:0.2:pi/2
                x = -sin(t1)*(l4*sin(t2 + t3) + l3*sin(t2) - l6*cos(t2 + t3 + t4) + l5*sin(t2 + t3 + t4));
                y =   cos(t1)*(l4*sin(t2 + t3) + l3*sin(t2) - l6*cos(t2 + t3 + t4) + l5*sin(t2 + t3 + t4));
                z =   l1 + l2 + l4*cos(t2 + t3) + l3*cos(t2) + l5*cos(t2 + t3 + t4) + l6*sin(t2 + t3 + t4);
                plot3(x,y,z,'*');
                hold on 
            end
        end
